      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
          ...
          .tab-bar button { font-size: 0.82rem !important; padding: 8px 14px !important; white-space: nowrap !important; }
          ...
          <div className="profile-card" style={{ background: "white", borderRadius: 20, padding: 32, boxShadow: "0 2px 12px rgba(26,63,111,0.08)" }}>
            ...
            {!editMode ? (
              ...
              <div>
                ...
                {saveError && (
                  <div style={{ padding: "12px 16px", background: "#FFF5F5", border: "1px solid #FED7D7", borderRadius: 10, color: "#9B1C1C", fontSize: "0.88rem", marginBottom: 16 }}>⚠️ {saveError}</div>
                )}
              </div>
            )}
