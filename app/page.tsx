...
const translations = {
  de: {
    ...
    hero: {
      badge: "Die Plattform für Kita-Fachkräfte",
      ...
      badges: ["DSGVO-konform", "Monatlich kündbar", "Sofort starten"],
  ...
  en: {
    ...
    hero: {
      ...
      badges: ["GDPR-compliant", "Cancel monthly", "Start immediately"],
    ...
    kitas: {
      ...
      features: ["View all professional profiles","Direct contact without intermediaries","Unlimited search and filters","Cancel monthly","No commission on hiring","Daycare profile visible to applicants"],
      btn: "Register now – €299/month",
      planLabel: "Main Plan",
      perMonth: "per month, excl. VAT",
      planFeatures: ["All professional profiles","Direct contact","Unlimited search","No commission","Cancel monthly","Daycare profile visible"],
